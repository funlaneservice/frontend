  ...
  if (!CLIENT_ID || unavailable) {
    return (
      <button
        type="button"
        disabled
        className="w-full h-12 inline-flex items-center justify-center gap-2 bg-surface text-ink border border-line font-semibold text-sm rounded-lg opacity-50 cursor-not-allowed"
      >
