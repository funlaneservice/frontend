...
import { LayoutDashboard, UserPlus, Users, ClipboardList, Settings, ShieldCheck, Landmark } from 'lucide-react';
...
const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Transactions', icon: Landmark, href: '/admin/transactions' },
